...
async function genererDatabook(){
  ...
  /* ---- Ratios de structure, rentabilité et liquidité (bas du bilan) ---- */
  {
    ...
    const actifCirc=c=>`(${BS("STOCKS",c)}+${BS("CLIENTS",c)}+${BS("AUTRES_CREANCES",c)}+${BS("AVANCES_FRS",c)}+${BS("HAO_ACTIF",c)}+${BS("TRESO_ACTIF",c)})`;
    const passifCirc=c=>`(-(${BS("FOURNISSEURS",c)}+${BS("CLIENTS_AVANCES",c)}+${BS("DETTES_SOCIALES",c)}+${BS("DETTES_FISCALES",c)}+${BS("AUTRES_DETTES",c)}+${BS("HAO_PASSIF",c)}+${BS("TRESO_PASSIF",c)}))`;
