...
function vueAccueil(){
  ...
  const barre=`<div class="card" style="display:flex;align-items:center;gap:10px">
    ...
    <button class="btn sm primary" style="margin-left:auto" onclick="ACC_LISTE=true;rendre();setTimeout(()=>{const e=document.getElementById('nouvNom');if(e)e.focus()},50)">+ Nouvelle société</button>
  </div>`;
